    ...
    <>
      <nav className="py-[9.5px] bg-white/80 backdrop-blur-lg flex items-center justify-between px-4 sticky top-0 z-30 border-b border-gray-200">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <LogOut
              className="text-red-600 hover:text-red-800 cursor-pointer transition-all duration-200"
              onClick={handleLogout}
            />
          </div>
          <div className="w-9 h-9 rounded-md bg-linear-to-br from-emerald-400 to-cyan-400 flex items-center justify-center font-bold text-white">
            JDK
          </div>
        </div>
      </nav>
